...
public class EmploymentQueryServiceImpl implements EmploymentQueryService {
    ...
    private Logger LOG = LoggerFactory.getLogger(EmploymentQueryServiceImpl.class);
    ...
    @Override
    public   Response queryInfo(String functionName, Map params, String serviceCode, EmploymentQueryController employmentQueryController) {

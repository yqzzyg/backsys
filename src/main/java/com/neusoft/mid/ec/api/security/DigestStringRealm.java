 ...
 */
public class DigestStringRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token)
        ...
        SimpleAuthenticationInfo authenticationInfo = new SimpleAuthenticationInfo("1234", // 用户名
                "1234", // 密码 // salt=username+salt
                getName() // realm name
        );
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // }
        /*
         * for (SysRole role : userInfo.getRoleList()) { authorizationInfo.addRole(role.getRole());
